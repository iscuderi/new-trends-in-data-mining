...
Excluimos del dataframe aquellos hechos en los que el sexo de la víctima es desconocido o *H* (se podría suponer que se trata de hombres, pero como se trata de una suposición y solo hay 52 lineas, no hay mayor costo de excluirlo), así como aquellos en los que la edad de la víctima es 0 (hay más de 100.000 hechos en los que esto es así, por lo que se deduce que se trata o bien de un error de carga o desconocimiento de la edad) o -1 (error de carga).
...
df_violacion= df_violacion[!(df_violacion$Vict.Sex=="X" | df_violacion$Vict.Sex=="H"),]
